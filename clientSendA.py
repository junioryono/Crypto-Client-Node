...
def main():
    ...
    while outsideLoop:
        ...
        if (outsideOption == '1'):
                ...
                while (insideLoop):
                    ...
                    if (insideOption == '1'):
                        ...
                        with open('balanceA.txt', 'w') as fileBalance:
                            fileBalance.write('A0000001:' + str(hex(balance1)) + '\n' + 'A0000002:' + str(hex(balance2)))
            ...
            try:
                accountBalances = open('balanceA.txt', 'r')
            except IOError:
                print('\nA0000001 Balance: 1000 BTC')
                print('A0000002 Balance: 1000 BTC')
            else:
                print('')
